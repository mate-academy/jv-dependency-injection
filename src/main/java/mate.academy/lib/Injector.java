...
public class Injector {
    ...
    public Object getInstance(Class<?> interfaceClazz) {
        ...
        for (Field field : declaredFields) {
            if (field.isAnnotationPresent(Inject.class)) {
                ...
                //set field type to interface class
    ...
    private Object createNewInstance(Class<?> clazz) {
        if (clazz.isInterface() && !interfaceImplementations.containsKey(clazz)) {
            throw new RuntimeException("can't create unsupported");
        } else if (!interfaceImplementations.values().contains(clazz)) {
