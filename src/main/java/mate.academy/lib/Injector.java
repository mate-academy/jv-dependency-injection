...
public class Injector {
    ...
    private static final String CANT_CREATE_NEW_INSTANCE_MESSAGE =
    ...
    public Object getInstance(Class<?> interfaceClazz) {
        isComponentAnnotationPresent(interfaceClazz);
    ...
    private Object createNewInstance(Class<?> clazz) {
        ...
        try {
            ...
            throw new RuntimeException(CANT_CREATE_NEW_INSTANCE_MESSAGE + clazz.getName(), e);
        }
    }
