...
public class Injector {
    ...
    private void validateImplementation(Class<?> clazz) {
        if (clazz == null) {
            throw new InvalidImplementationException("Implementation can't be null");
        }
        if (!clazz.isAnnotationPresent(Component.class)) {
            throw new InvalidImplementationException(
                    "Can't create an instance of a non-component class " + clazz.getName());
        }
    }
