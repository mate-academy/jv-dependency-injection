...
public class Injector {
    ...
    public Object getInstance(Class<?> interfaceClazz) {
        ...
        if (!clazz.isAnnotationPresent(Component.class)) {
            throw new RuntimeException("Injection failed. Annotation @Component is missed in "
                    + clazz.getName());
        }
        Field[] declaredFields = clazz.getDeclaredFields();
        for (Field field: declaredFields) {
            clazzImplementationInstance =
                    getClazzImplementationInstance(clazzImplementationInstance, clazz, field);
        }
    ...
    private Object createNewInstance(Class<?> clazz) {
        ...
        try {
            ...
            throw new RuntimeException("Cant create a new instance of "
                    + clazz.getName() + System.lineSeparator() + e);
        }
    }
