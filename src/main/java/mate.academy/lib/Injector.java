...
public class Injector {
    ...
    public Object getInstance(Class<?> interfaceClazz) {
        ...
        isAnnotationPresent(Component.class, clazz);
    ...
    private void isAnnotationPresent(Class<? extends Annotation> annotationClazz, Class<?> clazz) {
        if (!clazz.isAnnotationPresent(annotationClazz)) {
            throw new RuntimeException("Can't create instance of the class: "
            + clazz.getName() + ". " + annotationClazz + " annotation is missing.");
        }
    }
