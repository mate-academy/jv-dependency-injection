...
class InjectorTest {
  ...
  @Test
  public void component_isAnnotationPresent() {
  ...
  @Test
  public void inject_isAnnotationPresent() {
    ...
    public void getInstance_productParserInstance() {
        ProductParser actual = (ProductParser) injector.getInstance(ProductParser.class);

        Assertions.assertTrue(actual instanceof ProductParser,
                "Injector can't generate instance of ProductParser");
    }

    @Test
    public void getInstance_productServiceInstance() {
        ProductService actual = (ProductService) injector.getInstance(ProductService.class);
    ...
    public void getInstance_fileReaderInstance() {
        FileReaderService actual = (FileReaderService) injector.getInstance(FileReaderService.class);
